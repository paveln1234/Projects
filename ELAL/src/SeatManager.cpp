...
{
    m_capacity = 0;
    for(std::vector<Seat_t*>::iterator it = m_seats.begin();it != m_seats.end();it++)
    {
        delete *it;
    }
    m_seats.clear();
...
bool SeatManager::GetFreeSeat(vector<vector<Seat_t*>::iterator>& _it)
{
