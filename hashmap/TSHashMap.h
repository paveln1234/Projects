...
#ifndef __TSHASHMAP_H__
#define __TSHASHMAP_H__

#include <stddef.h>  /* size_t */

/** 
 *  @file TSHashMap.h
 *  @brief Generic Thread-Safe Hash map of key-value pairs implemented with separate chaining using linked lists.
 *	
 ...
 *  While ForEach and Update are thread-safe by themselves, Find, Insert, Size, and Remove should be used after calling LockItem, and followed by UnlockItem.  
 * 
 *  @author Thread-Safe version by Tomer Kalir
 *  @bug No known bugs.
 */


typedef struct TSHashMap TSHashMap;
typedef struct TSHashMap TSHashMap_t;
...
typedef void* (*UpdateFunction)(void* _value, void* _context);
 ...
 */
Map_Result TSHashMap_Rehash(TSHashMap *_map, size_t newCapacity);
...
Map_Stats TSHashMap_GetStatistics(const TSHashMap* _map);

#endif /* NDEBUG */


#endif /* __TSHASHMAP_H__ */
